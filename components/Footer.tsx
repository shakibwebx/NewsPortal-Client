        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="inline-block mb-4">
              <Image src="/logo.webp" alt="News Portal Logo" width={200} height={53} className="brightness-0 invert" />
            </Link>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">আমাদের সম্পর্কে</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/contact" className="hover:text-white transition">যোগাযোগ</Link></li>
              <li><Link href="/advertise" className="hover:text-white transition">বিজ্ঞাপন</Link></li>
