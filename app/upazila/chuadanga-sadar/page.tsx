...
export default function ChuadangaSadarPage() {
  ...
  const fetchNews = async (pageNum: number) => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/news?upazila=chuadanga-sadar&page=${pageNum}&limit=${LIMIT}`);
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">চুয়াডাঙ্গা সদর উপজেলার সর্বশেষ খবর</p>
        </div>
